...
write.csv(Bigungulates.hourly, "Bigungulates hourly.csv")
...
write.csv(Smallungulates.hourly, "Smallungulates hourly.csv")
...
write.csv(Bigcarnivores.hourly, "Bigcarnivores hourly.csv")
...
write.csv(Smallcarnivores.hourly, "Smallcarnivores hourly.csv")
...
write.csv(Bigungulates.monthly, "Bigungulates monthly.csv")
...
write.csv(Smallungulates.monthly, "Smallungulates monthly.csv")
...
write.csv(Bigcarnivores.monthly, "Bigcarnivores monthly.csv")
...
write.csv(Smallcarnivores.monthly, "Smallcarnivores monthly.csv")
